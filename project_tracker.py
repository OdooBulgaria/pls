...
class project_tracker(osv.osv):
    ...
    _columns={
              'work_description_id':fields.many2one('work.description',string='Work description'),
              ...
              'advance_paid-to_vendor':fields.float(string='Advance paid to vendor'),
              'balance_payment3':fields.float(string="Balance Payment3"),
              'done_by':fields.many2one('hr.employee',string='Done By'),
              'activity_start_date':fields.datetime(sting='Activity Start Date'),
              'activity_end_date':fields.datetime(sting='Activity End Date'),
              'wcc_sign_off_status':fields.selection(string='WCC sign off status',selection=[('Yes','Yes'),('No','No')]),
              'wcc_sign_off_date':fields.datetime('WCC Sign off Date'),
              'quality _document_uploaded_on_P6':fields.selection(string='Quality Document uploaded on P6',selection=[('Yes','Yes'),('No','No')]),
